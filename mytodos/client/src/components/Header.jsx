...
function Header() {
  return (
    <div className=" flex justify-between items-center p-3 text-xl border ">
      <div className="text-orange-500 text-2xl font-extrabold lg:ml-9 p-3">
        my<span className="text-blue-500">Bucket</span>
      </div>
      ...
      <a className="text-blue-500 font-extrabold lg:mr-6 lg:hidden" href={myResume} download="Resume.pdf">Download</a>
        <button className="text-orange-500 font-extrabold hidden md:block"><a href="">Hire Siddharth!</a></button>
          <Avatar
            src={myPhoto }
            radius="full"
            size="4"
